melb_df <- read.table("C:/Users/Public/Documents/Data/melbourne.csv",
  header = TRUE,
  sep = ",",
  skip = 11)
...
ox_df <- read.table(
  file = "C:/Users/Public/Documents/Data/oxford.txt",
  header = FALSE,
...
write.table(x = plot_df,
            file = "C:/Users/Public/Documents/Data/average-rainfall.csv",
            sep = ",",
            row.names = FALSE)
